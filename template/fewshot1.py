...
'''
few_shot_human_template1 = HumanMessagePromptTemplate.from_template(few_shot_human1)
...
'''
few_shot_ai_template1 = AIMessagePromptTemplate.from_template(few_shot_ai1)